...
sub Char::UHC::escape_script {
    ...
    if (/^ use Char::Euhc(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        # use Char::UHC version qw(ord reverse);
        $function_ord     = 'ord';
        $function_ord_    = 'ord';
...
=head1 SYNOPSIS
  ...
  use Char::UHC qw(ord reverse); --- demand enhanced feature of ord and reverse
  use Char::UHC ver.sion qw(ord reverse);
  use Char::UHC ver.sion.0 qw(ord reverse);
