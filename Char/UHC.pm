...
my $m_matched   = '';
my $s_matched   = '';
$m_matched   = q{@Char::Euhc::m_matched};
...
=item * Handles Raw UHC, No UTF8 flag like JPerl
...
functions.
  ...
  y///B       tr///
  chop        Char::Euhc::chop
  index       Char::Euhc::index
  rindex      Char::Euhc::rindex
  lc          Char::Euhc::lc
  lcfirst     Char::Euhc::lcfirst
  uc          Char::Euhc::uc
  ucfirst     Char::Euhc::ucfirst
  chr         Char::Euhc::chr
  glob        Char::Euhc::glob
  lstat       Char::Euhc::lstat
  opendir     Char::Euhc::opendir
  stat        Char::Euhc::stat
  unlink      Char::Euhc::unlink
  chdir       Char::Euhc::chdir
  do          Char::Euhc::do
  require     Char::Euhc::require
  ---------------------------------
...
=item * Reverse List Or String
  ...
  %barfoo = Char::UHC::reverse(%foobar);
...
=item * Special Variables $` And $& Doesn't Function
  ...
  is escaped to
    'AAABBBCCC' =~ /\G(?:[\x81-\xFE][\x00-\xFF]|[^\x81-\xFE])*?(?:BBB)@Char::Euhc::m_matched/;
