...
# eval <<"END" has eval "..."
if (eval Char::UHC::escape <<"END") {
eval Char::UHC::escape " if ('アソ' !~ /A/) { return 1 } else { return 0 } "
END
...
if (eval Char::UHC::escape <<"END") {
eval Char::UHC::escape qq{ if ('アソ' !~ /A/) { return 1 } else { return 0 } }
END
...
# eval <<"END" has eval '...'
if (eval Char::UHC::escape <<"END") {
eval Char::UHC::escape ' if (qq{アソ} !~ /A/) { return 1 } else { return 0 } '
END
...
# eval <<"END" has eval q{...}
if (eval Char::UHC::escape <<"END") {
eval Char::UHC::escape q{ if ('アソ' !~ /A/) { return 1 } else { return 0 } }
END
