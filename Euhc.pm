...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                                              2   3                                 4   5
                q<CORE::eval{local $UHC::re_t=%s; local $UHC::re_a=''; while($UHC::re_t =~ %s){%s local $^W=0; local $UHC::re_r=%s; %s$UHC::re_t="$UHC::re_a${1}$UHC::re_r$'"; pos($UHC::re_t)=length "$UHC::re_a${1}$UHC::re_r"; $UHC::re_a=substr($UHC::re_t,0,pos($UHC::re_t)); } return $UHC::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$UHC::re_r=CORE::eval $UHC::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $UHC::re_t=%s; while($UHC::re_t =~ %s){%s local $^W=0; local $UHC::re_r=%s; %s$UHC::re_t="$`$UHC::re_r$'"; pos($UHC::re_t)=length "$`$UHC::re_r"; } return $UHC::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $UHC::re_r=%s; %s"%s$UHC::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $UHC::re_n=0; local $UHC::re_a=''; while(%s =~ %s){%s local $^W=0; local $UHC::re_r=%s; %s%s="$UHC::re_a${1}$UHC::re_r$'"; pos(%s)=length "$UHC::re_a${1}$UHC::re_r"; $UHC::re_a=substr(%s,0,pos(%s)); $UHC::re_n++} return %s$UHC::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $UHC::re_n=0; while(%s =~ %s){%s local $^W=0; local $UHC::re_r=%s; %s%s="$`$UHC::re_r$'"; pos(%s)=length "$`$UHC::re_r"; $UHC::re_n++} return %s$UHC::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $UHC::re_r=%s; %s%s="%s$UHC::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $UHC::re_r=%s; %s%s="%s$UHC::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$UHC::re_r=CORE::eval $UHC::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
