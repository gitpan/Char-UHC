...
=item Make character
  ...
  set. For example, Euhc::chr(65) is "A" in either ASCII or UHC, not Unicode,
  and Euhc::chr(0x82a0) is a UHC HIRAGANA LETTER A. For the reverse of
  Euhc::chr, use UHC::ord.
